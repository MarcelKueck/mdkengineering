...
- **TimescaleDB** for time-series storage (PostgreSQL extension — we get the best of both worlds)
...
- **Tenant satisfaction** improved — they could see their building cared about air quality
