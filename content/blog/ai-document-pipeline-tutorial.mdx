...
For structured, predictable fields — part numbers (regex patterns), dates, standard form fields — rules are faster, cheaper, and more reliable than AI.

### Pass 2: LLM-based extraction

For unstructured content — descriptions, specifications embedded in paragraphs, contextual information — we use a language model with carefully crafted prompts.
